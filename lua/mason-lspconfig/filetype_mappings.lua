...
return {
  ...
  hbs = { "htmx", "oxfmt", "tailwindcss", "unocss" },
  heex = { "elixirls", "expert", "htmx", "lexical", "nextls", "tailwindcss" },
  helm = { "helm_ls", "snyk_ls", "snyk_ls" },
  hlsl = { "slangd" },
  hoon = { "hoon_ls" },
  html = { "angularls", "antlersls", "ast_grep", "biome", "codebook", "djlsp", "emmet_language_server", "emmet_ls", "harper_ls", "herb_ls", "html", "htmx", "ltex", "ltex_plus", "lwc_ls", "oxfmt", "stimulus_ls", "stylelint_lsp", "superhtml", "tailwindcss", "unocss", "vale_ls" },
  ...
  ["javascript.jsx"] = { "denols", "eslint", "oxfmt", "ts_ls", "vtsls" },
  ...
  mdx = { "htmx", "ltex_plus", "mdx_analyzer", "oxfmt", "tailwindcss" },
  menhir = { "ocamllsp" },
  ...
  ["typescript.tsx"] = { "angularls", "denols", "eslint", "oxfmt", "rome", "ts_ls", "vtsls" },
