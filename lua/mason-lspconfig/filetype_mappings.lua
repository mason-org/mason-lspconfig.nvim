...
return {
  ...
  hlsl = { "slangd" },
  hoon = { "hoon_ls" },
  html = { "angularls", "antlersls", "ast_grep", "biome", "codebook", "djlsp", "emmet_language_server", "emmet_ls", "harper_ls", "herb_ls", "html", "htmx", "ltex", "ltex_plus", "lwc_ls", "stimulus_ls", "stylelint_lsp", "superhtml", "tailwindcss", "unocss", "vale_ls" },
  ...
  jinja = { "jinja_lsp" },
  jq = { "jqls" },
  json = { "ast_grep", "biome", "dprint", "jsonls", "rome", "snyk_ls", "snyk_ls", "spectral" },
  ["json.openapi"] = { "vacuum" },
  ...
  mail = { "ltex", "ltex_plus" },
  make = { "autotools_ls" },
  markdown = { "codebook", "dprint", "grammarly", "harper_ls", "htmx", "ltex", "ltex_plus", "markdown_oxide", "marksman", "prosemd_lsp", "remark_ls", "rumdl", "tailwindcss", "unocss", "vale_ls", "zk" },
  ...
  python = { "ast_grep", "basedpyright", "codebook", "dprint", "harper_ls", "jedi_language_server", "pylsp", "pylyzer", "pyre", "pyrefly", "pyright", "ruff", "snyk_ls", "snyk_ls", "ty", "zuban" },
  qml = { "qmlls" },
  qmljs = { "qmlls" },
  ...
  vmasm = { "asm_lsp" },
  vsh = { "v_analyzer" },
  vue = { "biome", "emmet_language_server", "emmet_ls", "eslint", "htmx", "oxlint", "stylelint_lsp", "tailwindcss", "unocss", "vue_ls" },
  ["vue-html"] = { "unocss" },
  vv = { "v_analyzer" },
  ...
  xsl = { "lemminx" },
  xslt = { "lemminx" },
  yaml = { "ast_grep", "azure_pipelines_ls", "gh_actions_ls", "home_assistant", "hydra_lsp", "snyk_ls", "snyk_ls", "spectral", "yamlls" },
